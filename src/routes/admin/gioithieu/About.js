  ...
  render() {
    return (
        <div>
          ...
          {this.state.data.img1 !== undefined &&
          <div style={{ marginBottom: 16 }}>
            <label><b>Ảnh số 1:</b></label>
            {this.state.data.img1 && <Card bordered={false} className="imgWr"
                                                onClick={() => this.showModalSelectImage('img1')}
            >
              <img src={this.state.data.img1} />
            </Card>}

            <Button style={{marginRight: 10}}
                    onClick={() => this.showModalSelectImage('img1')}
            >Chọn ảnh từ thư viện</Button>
            {this.state.data.img1 && <Button
              onClick={() => {
          ...
          {this.state.data.img2 !== undefined &&
          <div style={{ marginBottom: 16 }}>
            <label><b>Ảnh số 2:</b></label>
            {this.state.data.img2 && <Card bordered={false} className="imgWr"
                                                onClick={() => this.showModalSelectImage('img2')}
            >
              <img src={this.state.data.img2} />
            </Card>}

            <Button style={{marginRight: 10}}
                    onClick={() => this.showModalSelectImage('img2')}
            >Chọn ảnh từ thư viện</Button>
            {this.state.data.img2 && <Button
              onClick={() => {
                this.setState(prevState => {
                  return {
                    ...prevState,
